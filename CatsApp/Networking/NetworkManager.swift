...
enum Link: String {
    case url = "https://api.thecatapi.com/v1/breeds?limit=10"
}
...
//    func fetchCats(from url: String,
//                   complition: @escaping(Result<[Cat], TypeError>) -> Void) {
...
//    }
    ...
    func fetchImage(from url: String,
                    complition: @escaping(Result<Data, TypeError>) -> Void) {
